...
enable_esc_exit = False # Set to True to enable the ESC key to exit the program
register_gesture_unit = 0 # 0 for gesture 1 to 10, 1 for gesture 11 to 20

hand_gesture = hg(num_hands,enable_pointer, show_fps, show_bounding_box, show_info_box, enable_csv_update, enable_esc_exit, register_gesture_unit)
